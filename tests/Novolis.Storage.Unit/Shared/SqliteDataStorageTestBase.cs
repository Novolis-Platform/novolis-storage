...
public abstract class SqliteDataStorageTestBase<T> where T : class, IHasId, new()
{
    private IHost? _host;
    ...
    public async Task SetUpHost()
    {
        ...
        builder.Services.AddStorage(b => b.AddSqliteProvider(o => o.ConnectionString = "Data Source=:memory:"));
        _host = builder.Build();
